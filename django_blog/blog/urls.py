...
from .views import RegisterView, PostCreateView, PostListView, CommentCreateView, CommentUpdateView, CommentDeleteView, PostDeleteView, PostDetailView, PostEditView, search    
from . import views
