...
from .views import RegisterView, PostCreateView, PostListView, CommentCreateView, CommentUpdateView, CommentDeleteView, PostDeleteView, PostDetailView, PostEditView, search, PostByTagListView    
from . import views
