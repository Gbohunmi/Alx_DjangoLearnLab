...
from .views import RegisterView, PostCreateView, PostListView, CommentCreateView, CommentEditView, CommentDeleteView, PostDeleteView, PostDetailView, PostEditView
from . import views
...
urlpatterns = [
    ...
    #Comment Views
    path("post/<int:pk>/comment/new/", CommentCreateView.as_view(), name="create-comment"),
    path("comment/<int:pk>/update/", CommentEditView.as_view(), name="edit-comment"),
