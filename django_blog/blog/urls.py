...
urlpatterns = [
    ...
    path("posts", PostListView.as_view(template_name="post_form.html"), name="posts"),
    path("posts/<int:pk>", PostCreateView.as_view(template_name="post_detail.html"), name="post-details"),
    path("/posts/<int:pk>/edit/", PostCreateView.as_view(template_name="edit_post.html"), name="edit-post"),
